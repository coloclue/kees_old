...
rtrsub -r -c filter-cache/rtrsub-cache.json --afi ipv4 < ./templates/bird-rpki.j2 > filter-cache/rpki/rpki-ipv4.conf
rtrsub -r -c filter-cache/rtrsub-cache.json --afi ipv6 < ./templates/bird-rpki.j2 > filter-cache/rpki/rpki-ipv6.conf
